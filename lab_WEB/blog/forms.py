...
from blog.models import Profile, Question, Tag, Answer
...
class SettingsForm(forms.Form):
    ...
    #     init_avatar = self.data['avatar']
    #     if len(init_avatar) < 1:
    #         return None
    #     return init_avatar
    ...
    def save(self, user_id):
        ...
        if self.cleaned_data.get("avatar", ""):
            print("AVA UPD:", self.files.get("avatar", ""))
            print("AVA TYPE:", type(self.files.get("avatar", "")))
